define('ember-auth/authenticators/devise', ['exports', 'ember', './base', 'ember-network/fetch'], function (exports, _ember, _base, _emberNetworkFetch) {
  'use strict';
  ...
  exports['default'] = _base['default'].extend({
    ...
    */
    makeRequest: function makeRequest(data) {
      ...
      return _emberNetworkFetch['default'](url, requestOptions);
    },
