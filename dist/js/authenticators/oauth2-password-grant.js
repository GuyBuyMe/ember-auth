define('ember-auth/authenticators/oauth2-password-grant', ['exports', 'ember', './base', 'ember-network/fetch'], function (exports, _ember, _base, _emberNetworkFetch) {
  'use strict';
  ...
  exports['default'] = _base['default'].extend({
    ...
    */
    makeRequest: function makeRequest(url, data) {
      ...
      return new RSVP.Promise(function (resolve, reject) {
        _emberNetworkFetch['default'](url, options).then(function (response) {
